...
* F_RallyResult        Rally results
     ...
     RallyName             RSF online rally name
     SetupFileName         Setup filename
     CutPenaltyTime        Time penalties from cutting (ie. does not include false start or other penalty times)
